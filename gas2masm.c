...
void emit_0_or_1_operandsq (void)
{
...
void emit_1_or_2_operandsq (void)
{
	int		j;
...
void emit_1_or_2_operandsq_vartext (char *str0, char *str1)
{
	int		j;
...
void special_fdivq (void)
{

	emit_1_or_2_operandsq_vartext ("fdiv", "fdivr");
}


void special_fdivpq (void)
{

	emit_1_or_2_operandsq_vartext ("fdivp", "fdivrp");
}


void special_fdivrq (void)
{

	emit_1_or_2_operandsq_vartext ("fdivr", "fdiv");
}


void special_fdivrpq (void)
{

	emit_1_or_2_operandsq_vartext ("fdivrp", "fdivp");
}


void special_fsubq (void)
{

	emit_1_or_2_operandsq_vartext ("fsub", "fsubr");
}


void special_fsubpq (void)
{

	emit_1_or_2_operandsq_vartext ("fsubp", "fsubrp");
}


void special_fsubrq (void)
{

	emit_1_or_2_operandsq_vartext ("fsubr", "fsub");
}


void special_fsubrpq (void)
{

	emit_1_or_2_operandsq_vartext ("fsubrp", "fsubp");
}
...
parsefield	parsedata[] = {
	...
	{".text",  "", 1, textsegstart},
	{"adcl",   " adc", 3, emittwooperandsl},
	{"adcq",   " adc", 3, emittwooperandsq}, // Quad word support
	{"addb",   " add", 3, emittwooperandsb},
	{"addl",   " add", 3, emittwooperandsl},
	{"addq",   " add", 3, emittwooperandsq}, // Quad word support
	{"andb",   " and", 3, emittwooperandsb},
	{"andl",   " and", 3, emittwooperandsl},
	{"andq",   " and", 3, emittwooperandsq}, // Quad word support
	{"call",   " call", 2, emitonecalldata},
	{"cmpb",   " cmp", 3, emittwooperandsb},
	{"cmpl",   " cmp", 3, emittwooperandsl},
	{"cmpq",   " cmp", 3, emittwooperandsq}, // Quad word support
	{"cmpw",   " cmp", 3, emittwooperandsw},
	{"decl",   " dec", 2, emitoneoperandl},
	{"decq",   " dec", 2, emitoneoperandq}, // Quad word support
	{"decw",   " dec", 2, emitoneoperandw},
	{"divl",   " div", 2, emitoneoperandl},
	{"divq",   " div", 2, emitoneoperandq}, // Quad word support
	//{"fadd",   " fadd", -2, emit_1_or_2_operandsl},
	{"fadd",   " fadd", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"faddp",  " faddp", -2, emit_1_or_2_operandsl},
	{"faddp",  " faddp", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"faddps", " faddp", -2, emit_1_or_2_operandsl},
	{"faddps", " faddp", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"fadds",  " fadd", -2, emit_1_or_2_operandsl},
	{"fadds",  " fadd", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"fcom",   " fcom", 2, emitoneoperandl},
	{"fcom",   " fcom", 2, emitoneoperandq}, // Quad word support
	//{"fcoms",  " fcom", 2, emitoneoperandl},
	{"fcoms",  " fcom", 2, emitoneoperandq}, // Quad word support
	//{"fcomp",  " fcomp", 2, emitoneoperandl},
	{"fcomp",  " fcomp", 2, emitoneoperandq}, // Quad word support
	//{"fcomps", " fcomp", 2, emitoneoperandl},
	{"fcomps", " fcomp", 2, emitoneoperandq}, // Quad word support
	{"fdiv",   "", -2, special_fdivq}, 
	{"fdivp",  "", -2, special_fdivpq}, 
	{"fdivr",  "", -2, special_fdivrq},
	{"fdivrp", "", -2, special_fdivrpq},
	{"fdivrs", "", -2, special_fdivrq},
	{"fildl",  " fild", 2, emitoneoperandl},
	{"fildq",  " fild", 2, emitoneoperandq}, // Quad word support
	{"fistl",  " fist", 2, emitoneoperandl},
	{"fistq",  " fist", 2, emitoneoperandq}, // Quad word support
	{"fistpl", " fistp", 2, emitoneoperandl},
	{"fistpq", " fistp", 2, emitoneoperandq}, // Quad word support
	//{"fld",    " fld", 2, emitoneoperandl},
	{"fldl",   " fld", 2, emitoneoperandl},
	{"fldq",   " fld", 2, emitoneoperandq}, // Quad word support
	{"fldcw",  " fldcw", 2, emitoneoperandw},
	//{"fldenv", " fldenv", 2, emitoneoperandl},
	{"fldenv", " fldenv", 2, emitoneoperandq}, // Quad word support
	//{"flds",   " fld", 2, emitoneoperandl},
	{"flds",   " fld", 2, emitoneoperandq}, // Quad word support
	//{"fmul",   " fmul", -2, emit_1_or_2_operandsl},
	{"fmul",   " fmul", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"fmulp",  " fmulp", -2, emit_1_or_2_operandsl},
	{"fmulp",  " fmulp", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"fmulps", " fmulp", -2, emit_1_or_2_operandsl},
	{"fmulps", " fmulp", -2, emit_1_or_2_operandsq}, // Quad word support
	//{"fmuls",  " fmul", -2, emit_1_or_2_operandsl},
	{"fmuls",  " fmul", -2, emit_1_or_2_operandsq}, // Quad word support
	{"fnstcw", " fnstcw", 2, emitoneoperandw},
	//{"fnstenv"," fnstenv", 2, emitoneoperandl},
	{"fnstenv"," fnstenv", 2, emitoneoperandq}, // Quad word support
	{"fnstsw", " fnstsw", 2, emitoneoperandw},
	{"fsqrt",  " fsqrt", 0, nooperands},
	//{"fstp",   " fstp", 2, emitoneoperandl},
	{"fstp",   " fstp", 2, emitoneoperandq}, // Quad word support
	//{"fstps",  " fstp", 2, emitoneoperandl},
	{"fstps",  " fstp", 2, emitoneoperandq}, // Quad word support
	//{"fsts",   " fst", 2, emitoneoperandl},
	{"fstl",   " fst", 2, emitoneoperandl},
	{"fstq",   " fst", 2, emitoneoperandq}, // Quad word support
	{"fsubr",  "", -2, special_fsubrq},
	{"fsubrp", "", -2, special_fsubrpq},
	{"fsubrs", "", -2, special_fsubrq},
	{"fsub",   "", -2, special_fsubq},
	{"fsubp",  "", -2, special_fsubpq},
	{"fsubps", "", -2, special_fsubpq},
	{"fsubs",  "", -2, special_fsubq},
	//{"fxch",   " fxch", 2, emitoneoperandl},
	{"fxch",   " fxch", 2, emitoneoperandq}, // Quad word support
	{"imull",  " imul", -2, emit_1_or_2_operandsl},
	{"imulq",  " imul", -2, emit_1_or_2_operandsq}, // Quad word support
	{"incl",   " inc", 2, emitoneoperandl},
	{"incq",   " inc", 2, emitoneoperandq}, // Quad word support
	{"ja",     " ja", 2, emitonedata},
	{"jae",    " jae", 2, emitonedata},
	{"jb",     " jb", 2, emitonedata},
	{"jbe",    " jbe", 2, emitonedata},
	...
	{"jz",     " jz", 2, emitonedata},
	{"leal",   " lea", 3, emittwooperandsl},
	{"leaq",   " lea", 3, emittwooperandsq}, // Quad word support
	{"movb",   " mov", 3, emittwooperandsb},
	{"movl",   " mov", 3, emittwooperandsl},
	{"movq",   " mov", 3, emittwooperandsq}, // Quad word support
	{"movw",   " mov", 3, emittwooperandsw},
	{"negl",   " neg", 2, emitoneoperandl},
	{"negq",   " neg", 2, emitoneoperandq}, // Quad word support
	{"orb",    " or", 3, emittwooperandsb},
	{"orl",    " or", 3, emittwooperandsl},
	{"orq",    " or", 3, emittwooperandsq}, // Quad word support
	{"popl",   " pop", 2, emitoneoperandl},
	{"popq",   " pop", 2, emitoneoperandq}, // Quad word support
	{"pushl",  " push", 2, emitoneoperandl},
	{"pushq",  " push", 2, emitoneoperandq}, // Quad word support
	//{"ret",    " ret", -1, emit_0_or_1_operandsl},
	{"ret",    " ret", -1, emit_0_or_1_operandsq}, // Quad word support
	{"rorl",   " ror", 3, emittwooperandsl},
	{"rorq",   " ror", 3, emittwooperandsq}, // Quad word support
	{"sarl",   " sar", 3, emittwooperandsl},
	{"sarq",   " sar", 3, emittwooperandsq}, // Quad word support
	{"sbbl",   " sbb", 3, emittwooperandsl},
	{"sbbq",   " sbb", 3, emittwooperandsq}, // Quad word support
	{"shll",   " shl", 3, emittwooperandsl},
	{"shlq",   " shl", 3, emittwooperandsq}, // Quad word support
	{"shrl",   " shr", 3, emittwooperandsl},	
	{"shrq",   " shr", 3, emittwooperandsq}, // Quad word support
	{"subl",   " sub", 3, emittwooperandsl},
	{"subq",   " sub", 3, emittwooperandsq}, // Quad word support
	{"testb",  " test", 3, emittwooperandsb},
	{"testl",  " test", 3, emittwooperandsl},
	{"testq",  " test", 3, emittwooperandsq}, // Quad word support
	{"xorb",   " xor", 3, emittwooperandsb},
	{"xorl",   " xor", 3, emittwooperandsl},
	{"xorq",   " xor", 3, emittwooperandsq}, // Quad word support
};
